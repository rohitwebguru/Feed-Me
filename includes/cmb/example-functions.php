 ...
 *
 * Be sure to replace all instances of 'feedme_' with your project's prefix.
...
function feedme_show_if_front_page( $cmb ) {
...
function feedme_hide_if_no_cats( $field ) {
...
function feedme_render_row_cb( $field_args, $field ) {
...
function feedme_display_text_small_column( $field_args, $field ) {
...
function feedme_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'feedme_register_demo_metabox' );
...
function feedme_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'feedme_show_if_front_page', // function should return a bool value
		...
		// 'classes_cb' => 'feedme_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'show_on_cb' => 'feedme_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// 'display_cb' => 'feedme_display_text_small_column', // Output the display of the column values through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'render_row_cb' => 'feedme_render_row_cb',
	...
	$cmb_demo->add_field( array(
		...
		'before_row'   => 'feedme_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'feedme_register_about_page_metabox' );
...
function feedme_register_about_page_metabox() {

	$prefix = 'feedme_about_';
...
add_action( 'cmb2_admin_init', 'feedme_register_repeatable_group_field_metabox' );
...
function feedme_register_repeatable_group_field_metabox() {

	$prefix = 'feedme_group_';
...
add_action( 'cmb2_admin_init', 'feedme_register_user_profile_metabox' );
...
function feedme_register_user_profile_metabox() {
...
add_action( 'cmb2_admin_init', 'feedme_register_taxonomy_metabox' );
...
function feedme_register_taxonomy_metabox() {
...
add_action( 'cmb2_admin_init', 'feedme_register_theme_options_metabox' );
...
function feedme_register_theme_options_metabox() {
	...
	$cmb_options = new_cmb2_box( array(
		...
		'option_key'      => 'feedme_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'      => 'feedme_options_page_message_callback',
...
function feedme_options_page_message_callback( $cmb, $args ) {
...
function feedme_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'feedme_register_rest_api_box' );
...
function feedme_register_rest_api_box() {
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'feedme_limit_rest_view_to_logged_in_users',
